...
STATUS=$EXP/status/qwen3_8b_layer0_bf16_vs_split_no_gptq_v5.status
OUT=$EXP/results/qwen3_8b_layer0_bf16_vs_split_no_gptq_v5
...
"$PYBIN" -u "$EXP/tools/bench_layer_bf16_vs_real_split_no_gptq_v5.py" \
  --model "$MODEL" \
  --layer_idx 0 \
  --seq_len 128 \
  --batches 16,64,256 \
