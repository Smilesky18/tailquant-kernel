...
export TORCH_EXTENSIONS_DIR=/data/yzy/tmp/torch_extensions_v50_qwen
...
mkdir -p /data/yzy/quarot-gpt-2/experiments/kernel_quant/layer_latency_split_v1/results/prefill_split_aligned_v50_qwen3_8b_full
...
/data/yzy/miniconda3/envs/romeo_sm120/bin/python -u \
  ...
  --component_warmup 1 \
  --component_iters 3 \
  --out_dir /data/yzy/quarot-gpt-2/experiments/kernel_quant/layer_latency_split_v1/results/prefill_split_aligned_v50_qwen3_8b_full \
  --local_files_only \
  --fused_topr_pack
