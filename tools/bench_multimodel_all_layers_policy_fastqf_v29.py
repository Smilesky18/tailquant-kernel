...
def main():
    ...
    for layer_idx in layer_ids:
        ...
        partial_csv = out_dir / "all_layers_policy_fastqf_v29_partial.csv"
        partial_json = out_dir / "all_layers_policy_fastqf_v29_partial.json"
        write_csv(partial_csv, rows)
        partial_json.write_text(json.dumps(rows, indent=2), encoding="utf-8")
        log(f"[PARTIAL] {partial_csv}")

    csv_path = out_dir / "all_layers_policy_fastqf_v29.csv"
    json_path = out_dir / "all_layers_policy_fastqf_v29.json"
    policy_csv = out_dir / "all_layers_policy_fastqf_v29_policy_summary.csv"
    meta_path = out_dir / "all_layers_policy_fastqf_v29_meta.json"
