...
void fused_topr_pack(
  ...
  TORCH_CHECK((K == 4096 || K == 12288), "fused_topr_pack v47 currently supports K=4096 or K=12288 only");
  TORCH_CHECK(R > 0 && R <= 256 && R < K, "fused_topr_pack v47 supports 0<R<=256");
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("fused_topr_pack", &fused_topr_pack, "CUB dynamic-smem fused top-r selection and split activation packing v47");
}
"""
