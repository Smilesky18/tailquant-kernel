...
void fused_topr_pack(
  ...
  TORCH_CHECK(K == 4096, "fused_topr_pack v55 currently supports K=4096 only");
  TORCH_CHECK(R > 0 && R <= 512 && R < K, "fused_topr_pack v55 supports 0<R<=512");
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("fused_topr_pack", &fused_topr_pack, "CUB fused top-r selection and split activation packing v55");
}
"""
