...
def main():
    ...
    log("[NOTE] Complete method paths are preserved; Split dense W4A4 uses QuaRot SM120 CUTLASS backend; q/k/v share Hadamard and k/v share topk where possible.")
    ...
    for layer_idx in layer_indices:
        for batch in batches:
            ...
            row = {
                ...
                "note": "hadamard_on_complete_paths_split_quarot_dense_sharedqkv_no_gptq_latency_only",
            }
    ...
    csv_path = out_dir / f"{args.label}_hadamard_three_schemes_quarot_dense_sharedqkv_v39.csv"
    json_path = out_dir / f"{args.label}_hadamard_three_schemes_quarot_dense_sharedqkv_v39.json"
