...
def parse_args():
    ...
    p.add_argument(
        ...
        default=(
            "bf16,romeo_qfactory,"
            "split_policy_qfactory_serial,split_policy_qfactory_sepbuf_serial,split_policy_qfactory"
        ),
    )
    ...
    p.add_argument(
        ...
        help="Use a small true-INT4 qfactory config table to avoid full autotune.",
    )
    return p.parse_args()


QFACTORY_QWEN3_SM120_V1 = {
    (2048, 4096, 4096): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (2048, 4096, 1024): {"NStage": 1, "TileM": 128, "TileN": 128, "TileK": 256, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (2048, 4096, 12288): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (2048, 12288, 4096): {"NStage": 2, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (8192, 4096, 4096): {"NStage": 1, "TileM": 128, "TileN": 128, "TileK": 256, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (8192, 4096, 1024): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (8192, 4096, 12288): {"NStage": 1, "TileM": 128, "TileN": 128, "TileK": 256, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (8192, 12288, 4096): {"NStage": 2, "TileM": 128, "TileN": 128, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (32768, 4096, 4096): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (32768, 4096, 1024): {"NStage": 1, "TileM": 128, "TileN": 128, "TileK": 256, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (32768, 4096, 12288): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (32768, 12288, 4096): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (2048, 4096, 11008): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (2048, 11008, 4096): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (8192, 4096, 11008): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (8192, 11008, 4096): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (32768, 4096, 11008): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (32768, 11008, 4096): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (2048, 4096, 14336): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (2048, 14336, 4096): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (8192, 4096, 14336): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (8192, 14336, 4096): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (32768, 4096, 14336): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
    (32768, 14336, 4096): {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128},
}


def install_qfactory_fast_preset(name: str):
    if name == "none":
        log("[QFACTORY_FAST_PRESET] none")
        return
    if name != "qwen3_sm120_v1":
        raise ValueError(f"Unknown qfactory fast preset: {name}")

    import qfactory.kernels.gemm_w4a4 as qgemm
    from qfactory.jit import jit

    def fast_gemm_int4_int4_nt(activation, weight, output):
        m, k_packed = activation.shape
        n, k_weight_packed = weight.shape
        assert k_packed * 2 == k_weight_packed * 2
        ...
        k = k_packed * 2
        cfg = QFACTORY_QWEN3_SM120_V1.get((int(m), int(k), int(n)))
        if cfg is None:
            cfg = {"NStage": 3, "TileM": 128, "TileN": 256, "TileK": 128, "WarpM": 64, "WarpN": 64, "WarpK": 128}
            log(f"[QFACTORY_FAST_PRESET_FALLBACK] M={m} K={k} N={n} cfg={cfg}")
        ...
        runtime = jit.compile_and_tune(
            ...
            includes=qgemm.includes,
            template=qgemm.template,
            perf_keys={"M": m},
            keys={"N": n, "K": k},
            space=(cfg,),
            args=args,
    ...
    QF19.gemm_int4_int4_nt = fast_gemm_int4_int4_nt
    log(f"[QFACTORY_FAST_PRESET] installed {name} with {len(QFACTORY_QWEN3_SM120_V1)} shape configs")


def patch_qfactory_raw_backend_serial_split(layer):
    """Force split qfactory modules to run dense+scale+sparse on the current stream."""
    patched = []

    for name, mod in layer.named_modules():
        if not QF19.is_real_policy_linear(mod):
            continue
        if not getattr(mod, "is_split", False):
            continue

        def make_qf_split_compute_serial(module_name):
            def qf_split_compute_serial(
                self,
                A,
                scratch,
                B_col,
            ...
            return qf_split_compute_serial

        mod._split_compute = types.MethodType(make_qf_split_compute_serial(name), mod)
        patched.append({
            "name": name,
            "K": int(mod.K),
            "N": int(mod.N),
            ...
            "schedule": "serial_current_stream",
        })

    log("[PATCH_QFACTORY_SERIAL_SPLIT] " + json.dumps(patched, indent=2))
    return patched



def patch_qfactory_raw_backend_sepbuf_serial_split(layer):
    """Run split qfactory dense and sparse sequentially but keep async-style separate buffers and final add."""
    patched = []
    ...
    for name, mod in layer.named_modules():
        ...
        def make_qf_split_compute_sepbuf_serial(module_name):
            def qf_split_compute_sepbuf_serial(
                self,
                A,
                scratch,
                B_col,
            ...
            return qf_split_compute_sepbuf_serial

        mod._split_compute = types.MethodType(make_qf_split_compute_sepbuf_serial(name), mod)
        patched.append({
            "name": name,
            "K": int(mod.K),
            "N": int(mod.N),
            "R": int(getattr(mod, "R", 0)),
            "ratio": float(getattr(mod, "ratio", 0.0)),
            "schedule": "sepbuf_serial_current_stream",
        })

    log("[PATCH_QFACTORY_SEPBUF_SERIAL_SPLIT] " + json.dumps(patched, indent=2))
    return patched
...
def build_variant_layer(
    *,
    ...
    elif variant in {"split_policy_current", "split_policy_qfactory", "split_policy_qfactory_serial", "split_policy_qfactory_sepbuf_serial"}:
        cfg_by_local = {}
    ...
    if variant in {
        ...
        "split_policy_qfactory_serial",
        "split_policy_qfactory_sepbuf_serial",
    }:
        patch_qfactory_raw_backend(layer)
        if variant == "split_policy_qfactory_serial":
            patch_qfactory_raw_backend_serial_split(layer)
        elif variant == "split_policy_qfactory_sepbuf_serial":
            patch_qfactory_raw_backend_sepbuf_serial_split(layer)
...
def add_ratios(row: dict):
    ...
    split_policy_serial = row.get("split_policy_qfactory_serial_ms")
    split_policy_sepbuf_serial = row.get("split_policy_qfactory_sepbuf_serial_ms")
    if bf16 and pure:
    ...
    if split_policy_serial and split_policy:
        row["split_policy_qfactory_async_over_serial"] = split_policy / split_policy_serial
        row["split_policy_qfactory_async_speedup_vs_serial"] = split_policy_serial / split_policy
    if split_policy_sepbuf_serial and split_policy:
        row["split_policy_qfactory_async_over_sepbuf_serial"] = split_policy / split_policy_sepbuf_serial
        row["split_policy_qfactory_async_speedup_vs_sepbuf_serial"] = split_policy_sepbuf_serial / split_policy
    if romeo and split_policy_serial:
        row["split_policy_qfactory_serial_over_romeo_qfactory"] = split_policy_serial / romeo
    if romeo and split_policy_sepbuf_serial:
        row["split_policy_qfactory_sepbuf_serial_over_romeo_qfactory"] = split_policy_sepbuf_serial / romeo
...
def main():
    ...
    log(f"[QFACTORY_FAST_PRESET_ARG] {args.qfactory_fast_preset}")
    ...
    for layer_idx in layer_ids:
        ...
        partial_csv = out_dir / "all_layers_policy_async_ablation_v30_partial.csv"
        partial_json = out_dir / "all_layers_policy_async_ablation_v30_partial.json"
        write_csv(partial_csv, rows)
        partial_json.write_text(json.dumps(rows, indent=2), encoding="utf-8")
        log(f"[PARTIAL] {partial_csv}")

    csv_path = out_dir / "all_layers_policy_async_ablation_v30.csv"
    json_path = out_dir / "all_layers_policy_async_ablation_v30.json"
    policy_csv = out_dir / "all_layers_policy_async_ablation_v30_policy_summary.csv"
    meta_path = out_dir / "all_layers_policy_async_ablation_v30_meta.json"
