...
STATUS=$EXP/status/pure_mlp_gate_up_shared_pack_v10.status
OUT=$EXP/results/pure_mlp_gate_up_shared_pack_v10
...
"$PYBIN" -u "$EXP/tools/bench_pure_mlp_share_pack_v10.py" \
  --model "$MODEL" \
  --layer_idx 0 \
  --seq_len 128 \
  --batches 16,64 \
