...
STATUS=$EXP/status/qwen3_8b_layer0_bf16_pure_split_no_gptq_v8.status
OUT=$EXP/results/qwen3_8b_layer0_bf16_pure_split_no_gptq_v8
...
"$PYBIN" -u "$EXP/tools/bench_layer_bf16_pure_split_no_gptq_v8.py" \
  --model "$MODEL" \
  --layer_idx 0 \
  --seq_len 128 \
  --batches 16,64,256 \
