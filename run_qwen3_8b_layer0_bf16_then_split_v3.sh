...
STATUS=$EXP/status/qwen3_8b_layer0_bf16_then_split_v3.status
BF16_OUT=$EXP/results/qwen3_8b_layer0_bf16_v3
SPLIT_OUT=$EXP/results/qwen3_8b_layer0_split_real_v3
SUMMARY=$EXP/reports/qwen3_8b_layer0_bf16_vs_split_v3_summary.json
CSV=$EXP/reports/qwen3_8b_layer0_bf16_vs_split_v3_summary.csv
